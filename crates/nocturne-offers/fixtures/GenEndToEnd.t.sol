...
// Fixture generator for nocturne-offers end-to-end parity (Tier 0).
//
...
//   cp crates/nocturne-offers/fixtures/GenEndToEnd.t.sol <midnight>/test/GenEndToEnd.t.sol
//   cd <midnight> && forge test --match-contract GenEndToEnd -vv
//   # copy the printed constants into crates/nocturne-offers/tests/parity_e2e.rs, then delete the copy
