...
/// Registered MidnightBundles V1 deployment on Base mainnet.
pub const BASE_MIDNIGHT_BUNDLES: Address = [
    0x09, 0x11, 0x83, 0xd7, 0x29, 0xbe, 0x9f, 0x80, 0x8c, 0x21, 0x2b, 0x47, 0x5e, 0x38, 0x7a, 0x12,
    0xe6, 0x78, 0x50, 0xa7,
];
