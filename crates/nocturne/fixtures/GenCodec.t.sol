...
// Fixture generator for nocturne ABI calldata codec parity.
//
...
//   cp crates/nocturne/fixtures/GenCodec.t.sol <midnight>/test/GenCodec.t.sol
//   cd <midnight> && forge test --match-contract GenCodec -vv
//   # copy the printed constants into crates/nocturne/tests/codec.rs, then delete the copy
